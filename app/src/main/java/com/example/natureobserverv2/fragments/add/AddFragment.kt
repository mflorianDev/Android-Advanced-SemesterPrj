...
class AddFragment : Fragment(), View.OnClickListener {
    ...
    private fun insertObservationToDatabase() {
        ...
        if (inputCheck(title, date, location, notes)){
            ...
            Toast.makeText(requireContext(), getString(R.string.savedToastNewObservation), Toast.LENGTH_LONG).show()
            // Navigate back
            findNavController().navigate(R.id.action_addFragment_to_listFragment)
        } else {
            Toast.makeText(requireContext(), getString(R.string.saveErrorToastNewObservation), Toast.LENGTH_LONG).show()
        }
    }
